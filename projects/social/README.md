...
About 500 times because everytime add_friendship is called it creates a friend for both users, so everytime it's called 2 people gain a friend. 100 users / 2 friends per call * 10 friends = 500 calls
